...
using MiniEcommerce.Configurations.Inventories;
using MiniEcommerce.Configurations.InventoryTickets;
using MiniEcommerce.Configurations.Manufacturers;
using MiniEcommerce.Configurations.Orders;
using MiniEcommerce.Configurations.ProductAttributes;
using MiniEcommerce.Configurations.ProductCategories;
using MiniEcommerce.Configurations.Products;
using MiniEcommerce.Configurations.Promotions;
